...
function buildLivePriorityEvidence(args: {
  ...
  return {
    ...
    evidenceRules: [
      ...
      "Never label QQQ, NDX, SPY, SPX or SPXW prices or strikes as NQ or ES futures. Use only livePrice and sessionOhlc for futures prices unless an explicit futures calibration is supplied.",
...
export async function POST(request: NextRequest) {
  ...
  const system = [
    ...
    ...(historicalReplay ? [
      ...
      "Keep price domains separate. QQQ/NDX and SPY/SPX/SPXW option strikes are not NQ/ES futures prices. Only state a futures-equivalent Gamma or Kwant level when the context explicitly supplies a verified futures calibration; otherwise state the options-underlying strike and label it clearly.",
