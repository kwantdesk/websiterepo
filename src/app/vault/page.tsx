      ...
      {showPublish && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60" onClick={() => setShowPublish(false)}>
          <div className="w-[600px] rounded-2xl border border-border bg-panel p-6 shadow-2xl" onClick={(e) => e.stopPropagation()}>
            ...
            {publishStep === 1 && <div className="space-y-3"><input placeholder="Strategy name" className="w-full rounded-xl border border-border bg-surface px-3 py-2 text-[13px] outline-none" /><textarea rows={4} placeholder="Description" className="w-full resize-none rounded-xl border border-border bg-surface px-3 py-2 text-[13px] outline-none" /><div className="grid grid-cols-2 gap-3"><select className="rounded-xl border border-border bg-surface px-3 py-2 text-[13px]"><option>Scalping</option><option>Intraday</option><option>Swing</option><option>Position</option></select><select className="rounded-xl border border-border bg-surface px-3 py-2 text-[13px]"><option>5m</option><option>15m</option><option>1h</option><option>4h</option></select></div><input placeholder="Instrument tags: NAS100, XAUUSD" className="w-full rounded-xl border border-border bg-surface px-3 py-2 text-[13px] outline-none" /><select className="w-full rounded-xl border border-border bg-surface px-3 py-2 text-[13px]"><option>Kwantify JavaScript</option><option>Pine Script</option><option>Python</option><option>C#</option><option>MQL5</option></select></div>}
