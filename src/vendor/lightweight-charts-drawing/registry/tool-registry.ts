...
const TOOL_DEFINITIONS: ToolRegistryEntry[] = [
  ...
  kwantTool('xabcd-pattern', 'XABCD Pattern', 'annotation', 5),
  kwantTool('cypher-pattern', 'Cypher Pattern', 'annotation', 5),
  kwantTool('head-and-shoulders', 'Head and Shoulders', 'annotation', 7),
  kwantTool('abcd-pattern', 'ABCD Pattern', 'annotation', 4),
  kwantTool('triangle-pattern', 'Triangle Pattern', 'annotation', 4),
  kwantTool('three-drives-pattern', 'Three Drives Pattern', 'annotation', 7),
  kwantTool('cyclic-lines', 'Cyclic Lines', 'annotation', 2),
  kwantTool('time-cycles', 'Time Cycles', 'annotation', 2),
  kwantTool('sine-line', 'Sine Line', 'annotation', 2),
  kwantTool('ghost-feed', 'Ghost Feed', 'annotation', 2),
  kwantTool('image-content', 'Image', 'annotation', 1),
  kwantTool('post-content', 'Post', 'annotation', 1),
  kwantTool('idea-content', 'Idea', 'annotation', 1),
