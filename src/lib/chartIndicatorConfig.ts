...
export const INDICATOR_NUMERIC_SETTINGS: Record<string, IndicatorNumericSetting[]> = {
  ...
  "dark-pool-gex": [
    { key: "lookbackDays", label: "Lookback (days)", defaultValue: 30, min: 1, max: 180, step: 1 },
    { key: "topN", label: "Largest individual prints", defaultValue: 5, min: 1, max: 20, step: 1 },
    ...
    { key: "bandThickness", label: "Price-memory thickness", defaultValue: 6, min: 1, max: 30, step: 0.5 },
    { key: "bandOpacity", label: "Price-memory opacity (%)", defaultValue: 24, min: 0, max: 100, step: 1 },
    { key: "originMarkerSize", label: "Origin marker size", defaultValue: 7, min: 2, max: 24, step: 0.5 },
    { key: "haloIntensity", label: "GEX halo intensity (%)", defaultValue: 70, min: 0, max: 100, step: 1 },
