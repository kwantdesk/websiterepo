...
export const INDICATOR_NUMERIC_SETTINGS: Record<string, IndicatorNumericSetting[]> = {
  ...
  "dark-pool-gex": [
    ...
    { key: "interactionTolerance", label: "Touch tolerance", defaultValue: 1, min: 0, max: 100, step: 0.01 },
    { key: "breakThresholdTicks", label: "Confirmed break (ticks)", defaultValue: 2, min: 1, max: 100, step: 1 },
    { key: "reactionThresholdTicks", label: "Reaction threshold (ticks)", defaultValue: 4, min: 1, max: 500, step: 1 },
    { key: "reactionHorizonMs", label: "Post-touch horizon (ms)", defaultValue: 1800000, min: 1000, max: 86400000, step: 1000 },
    { key: "minimumResearchSamples", label: "Minimum research touches", defaultValue: 10, min: 1, max: 1000, step: 1 },
    ...
    { key: "bandThickness", label: "Interaction halo thickness", defaultValue: 2, min: 1, max: 30, step: 0.5 },
    { key: "bandOpacity", label: "Interaction halo opacity (%)", defaultValue: 12, min: 0, max: 100, step: 1 },
    { key: "originMarkerSize", label: "Origin marker size", defaultValue: 7, min: 2, max: 24, step: 0.5 },
    { key: "haloIntensity", label: "GEX halo intensity (%)", defaultValue: 20, min: 0, max: 100, step: 1 },
