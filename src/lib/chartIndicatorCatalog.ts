...
export const CHART_INDICATOR_CATALOG: ChartIndicatorDefinition[] = [
  ...
  indicator("KWANT Print (Footprint)", "Order Flow", "Bid/ask footprint at every traded price.", true, "Reference", "Deep Print (Footprint)"),
  ...
  indicator("Gamma Levels", "Market Structure", "Session-anchored KwantData gamma walls with selectable QQQ/NDX-to-NQ/MNQ and SPY/SPX-to-ES/MES conversion.", false, "Kwantify"),
