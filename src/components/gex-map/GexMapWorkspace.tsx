...
import { default as GexMapDropdown } from "@/components/KwantSelect";
...
// The dropdown moved to components/KwantSelect so the whole site shares one
// menu instead of each surface growing its own. Re-exported under the old name
// so existing call sites keep working.
export { GexMapDropdown };
