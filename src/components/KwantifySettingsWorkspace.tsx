        ...
        <div className="mx-auto max-w-4xl">
          ...
          {activeTab === "Account settings" && (
            <div className="mt-8 space-y-6">
              ...
              <section className="rounded-2xl border border-border bg-panel p-6"><h2 className={sectionTitle}>Session</h2><p className="text-[13px] text-muted">Sign out of KwantDesk on this device.</p><button type="button" onClick={async () => { await supabase?.auth?.signOut(); window.location.href = "/login?returnTo=/"; }} className="mt-4 rounded-xl border border-border bg-surface px-4 py-2 text-[13px] font-semibold text-foreground transition-colors hover:border-danger/40 hover:text-danger">Sign out</button></section>
