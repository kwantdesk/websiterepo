...
const themePresets: { name: string; colors: ThemeColors }[] = [
  { name: "Kwant Desk", colors: makeTheme({ background: "#000000", panel: "#030604", surface: "#07100A", card: "#020905", foreground: "#FFFFFF", primary: "#B6FF00", secondary: "#4361FF", accent: "#4361FF", muted: "#7E8980", border: "#142019", danger: "#4361FF", chartBackground: "#000000", gridColor: "#0A140C", crosshairColor: "rgba(182,255,0,.78)", candleUp: "#B6FF00", candleDown: "#FFFFFF" }) },
