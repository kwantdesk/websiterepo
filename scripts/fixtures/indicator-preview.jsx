...
const candles = Array.from({ length: previewId === "absolute-levels" ? 30 : previewId === "pivot-points" ? 96 : 100 }, (_, i) => {
  ...
  return { timestamp: 1700000000000 + i * (previewId === "pivot-points" || previewId === "price-movement-levels" ? 3600000 : 60000), open: close - 0.2, close, high: close + 0.3, low: close - 0.4, volume: 10 };
});
