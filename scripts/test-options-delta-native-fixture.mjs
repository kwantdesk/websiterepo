...
const fixture = JSON.parse(readFileSync(new URL(
  "../native/parity/fixtures/charts/options-delta-authoritative.json",
  import.meta.url,
), "utf8"));

const defaults = defaultIndicatorSettings("options-delta");
...
const points = buildOptionsDeltaSeries({
...
console.log("Options Delta browser/native authority fixture passed.");
